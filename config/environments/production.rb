Rails.application.configure do
  ...
  # config_endpoint = "converly.zh27pu.cfg.use1.cache.amazonaws.com:11211"
  ...
  # config.active_job.queue_name_prefix = "dotone_api_production"
  ...
  config.action_mailer.default_url_options = { host: ENV.fetch('HOST', '3.137.214.220') }
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    address: 'email-smtp.us-east-1.amazonaws.com',
    user_name: ENV.fetch('AWS_SMTP_ACCESS_KEY', nil), # Your SMTP user here.
    password: ENV.fetch('AWS_SMTP_SECRET_KEY', nil), # Your SMTP password here.
